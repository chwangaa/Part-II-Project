 ...
 * In the temporary matrices in each computation of
 * submatrix is first set to be large enough, hence the trick
 * However, in this version, this is not necessary
...
void strassen_mm(
    ...
    */
    ...
    Dtype* const A_1_1 = A;
    Dtype* const A_1_2 = A_1_1 + k1;
    Dtype* const A_2_1 = A_1_1 + incRowA*m1;
    Dtype* const A_2_2 = A_2_1 + k1;
    ...
    Dtype* const B_1_1 = B;
    Dtype* const B_1_2 = B_1_1 + n1;
    Dtype* const B_2_1 = B_1_1 + incRowB*k1;
    Dtype* const B_2_2 = B_2_1 + n1;
